...
?>
<script src="https://www.paypal.com/sdk/js?client-id=AX8ORAFVAtd-vUKaTLV4iyp2mPgs1dZai5JmyzQq0M8KKInHVFdSpWAH--foyJkC-ThIVEytYxBtImVm"></script>
<script>
    ...
    return actions.order.create({
      purchase_units: [{
        amount: {
		  ...
		  description: "Compra de artículos en  <?=NOMBRE_EMPRESA ?> por valor de <?=SMONEY.$total ?>",  
      }]
    });
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Minima vel, voluptatum officiis modi eveniet porro aliquam alias fugiat nulla? Debitis incidunt eveniet cupiditate, molestiae quod odio dolores consequatur quaerat ab.</p>
       <br>
       <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Praesentium, ipsa eveniet. Beatae, ipsum consequatur dignissimos labore doloremque provident animi repellat totam, laboriosam dolorum iste temporibus perferendis maiores illo cumque officia!</p>
      </div>
