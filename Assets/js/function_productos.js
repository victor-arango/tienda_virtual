...
// genera el codigo de barras si el codigo es mayor a 5 digitos
...
//FUNCION PARA REALIZAR LA CARGA DE LAS IMAGENES DE LOS PRODUCTOS
...
//FUNCION PARA ELIMINAR LAS IMAGENES DE LOS PRODUCTOS 
function fntDelItem(element){
 ...
 // funcion para visualizar la informacion del producto 
...
function fntDelInfo(idProducto){
    swal({
        ...
        text: "¿Realmente quiere eliminar al producto?",
        type: "warning",
 ...
 //funcion permite ver las categorias disponibles en el formulario 
...
// funcion para la impresion del  codigo de barras
