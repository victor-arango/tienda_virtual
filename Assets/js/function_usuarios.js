...
//AGREGA LOS EVENTOS  QUE VAMOS A CARGAR AL MOMEMENTO DE CARGAR EL DOCUMENTO 
document.addEventListener('DOMContentLoaded', function(){
    ...
    if(document.querySelector("#formPerfil")){
        ...
        for (let i = 0; i < elementsValid.length; i++){
            if(elementsValid[i].classList.contains('is-invalid')){
                swal("Atencion", "Por favor verfica todos los campos.", "error");
                return false;
            }
        }
        divLoading.style.display = "flex";
...
//ACTUALZIAR DATOS FISCALES DEL USUARIO 
...
//EJECUTA LA FUNCION PARA PEDIR A AJAX LOS ROLES DE LOS USUARIOS 
...
//FUNCION PARA LLAMAR LOS ROLES YA EXISTENTES EN LA BD 
...
// FUNCION  PARA ABRIR EL MODAL VER INFORMACION DE LOS USUARIOS 
...
// FUNCION  PARA ABRIR EL MODAL DE USUARIOS 
