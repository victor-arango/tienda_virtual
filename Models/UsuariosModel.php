<?php 
	...
	class UsuariosModel extends Mysql
	{
        ...
        public function insertUsuario(string $identificacion, string $nombre, string $apellido, int $telefono, string $email, string $password, int $tipoid, int $status){
            ...
            //METODO PARA VER EL USUARIO SELECCIONADO EN EL MODAL 
        ...
        //METODO PARA LA ACTUALIZACION DE DATOS DE LOS USUARIOS 
        ...
        // SCRIPT PARA LA ELIMINACION DE USUARIOS DESDE LA BASE DE DATOS 
		...
		// GUARDA LA INFORMACION QUE SE ACTUALIZARA DEL PERFIL DEL USUARIO
		...
		// ACTUALIZA LOS DATOS FISCALES DEL USUARIO 
