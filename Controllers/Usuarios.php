<?php 
	...
	class Usuarios extends Controllers{
		...
		public function Usuarios()
		{
			...
			//METODO PARA LA INSERCCION Y LA MODIFICACION DE LOS DATOS DE LOS USUARIOS 
			...
			if($_POST){
				...
				if(empty($_POST['txtIdentificacion']) || empty($_POST['txtNombre']) || empty($_POST['txtApellido']) || empty($_POST['txtTelefono']) || empty($_POST['txtEmail']) || empty($_POST['listRolid']) || empty($_POST['listStatus']) )
				{
					...
					if($request_user > 0)
					{
						...
						$arrResponse = array('status' => false, 'msg' => '¡Atencion! el email o la identificacion ya existen, verifica.');
					}else{
		...
		// Metodo para extraer los datos de los usuarios
		...
		// METODOS PARA LA OBTENCION DEL PERFIL
		...
		public function putPerfil(){
			...
			//METODO PARA GUARDAR LOS DATOS EN VARIABLES 
