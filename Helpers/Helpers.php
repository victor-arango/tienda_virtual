<?php 
    ...
    // OBTENEMOS LOS PERMISOS QUE TIENE EL MODULO
    function getPermisos(int $idmodulo){
        require_once("Models/PermisosModel.php");
        $objPermisos = new permisosModel();
        //obtenemos el id de la session de la cual se esta logeado
    ...
    // ENVIA LA FOTO A ALA RUTA DE UPLOADS Y A LA BD
    ...
    function getTokenPaypal(){
        ...
        curl_setopt($payLogin, CURLOPT_USERPWD, IDCLINTE.":".SECRET);
